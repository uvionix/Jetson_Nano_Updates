...
echo "*** Applying patch-001-28-Nov-2022 - Adding modem watchdog service started upon system boot ***"
...
cp /home/$usr/Repos/Jetson_Nano_Linux_Services/modem-watchdog.service /etc/systemd/system/
...
echo "Enable the modem watchdog service..."
